 ...
 *  Compilation:  javac ie.davidloftus.algorithms.compression.BinaryIn.java
 *  Execution:    java ie.davidloftus.algorithms.compression.BinaryIn input output
 *  Dependencies: none             
 *  
 *  This library is for reading binary data from an input stream.
 *
 *  % java ie.davidloftus.algorithms.compression.BinaryIn https://introcs.cs.princeton.edu/java/cover.png output.png
 *
 ******************************************************************************/
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to {@code ie.davidloftus.algorithms.compression.BinaryIn} with calls
...
public final class BinaryIn {
   ...
   /**
     * Unit tests the {@code ie.davidloftus.algorithms.compression.BinaryIn} data type.
