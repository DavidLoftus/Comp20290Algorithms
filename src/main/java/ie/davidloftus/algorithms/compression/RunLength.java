 ...
 *  Compilation:  javac ie.davidloftus.algorithms.compression.RunLength.java
 *  Execution:    java ie.davidloftus.algorithms.compression.RunLength - < input.txt   (compress)
 *  Execution:    java ie.davidloftus.algorithms.compression.RunLength + < input.txt   (expand)
 *  Dependencies: ie.davidloftus.algorithms.compression.BinaryIn.java ie.davidloftus.algorithms.compression.BinaryOut.java
 ...
 *  run-length encoding.
 *
 *  % java ie.davidloftus.algorithms.compression.BinaryDump 40 < 4runs.bin
 *  0000000000000001111111000000011111111111
 *  40 bits
 *
 *  This has runs of 15 0s, 7 1s, 7 0s, and 11 1s.
 *
 *  % java ie.davidloftus.algorithms.compression.RunLength - < 4runs.bin | java ie.davidloftus.algorithms.compression.HexDump
 *  0f 07 07 0b
 *  4 bytes
 *
 ******************************************************************************/
...
/**
 *  The {@code ie.davidloftus.algorithms.compression.RunLength} class provides static methods for compressing
