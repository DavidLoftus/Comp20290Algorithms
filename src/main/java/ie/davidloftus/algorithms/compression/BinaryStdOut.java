 ...
 *  Compilation:  javac ie.davidloftus.algorithms.compression.BinaryStdOut.java
 *  Execution:    java ie.davidloftus.algorithms.compression.BinaryStdOut
 *  Dependencies: none
 *
 ...
 *  <p>
 *  The client should not intermix calls to {@code ie.davidloftus.algorithms.compression.BinaryStdOut} with calls
 *  to {@code ie.davidloftus.algorithms.compression.StdOut} or {@code System.out}; otherwise unexpected behavior
 *  will result.
 *
...
public final class BinaryStdOut {
    ...
    private static boolean isInitialized;     // has ie.davidloftus.algorithms.compression.BinaryStdOut been called for first time?

    // don't instantiate
    private BinaryStdOut() { }

    // initialize ie.davidloftus.algorithms.compression.BinaryStdOut
