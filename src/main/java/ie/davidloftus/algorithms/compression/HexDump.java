 ...
 *  Compilation:  javac ie.davidloftus.algorithms.compression.HexDump.java
 *  Execution:    java ie.davidloftus.algorithms.compression.HexDump < file
 *  Dependencies: ie.davidloftus.algorithms.compression.BinaryStdIn.java ie.davidloftus.algorithms.compression.StdOut.java
 ...
 *  ABRACADABRA!
 *
 *  % java ie.davidloftus.algorithms.compression.HexDump 16 < abra.txt
...
/**
 *  The {@code ie.davidloftus.algorithms.compression.HexDump} class provides a client for displaying the contents
