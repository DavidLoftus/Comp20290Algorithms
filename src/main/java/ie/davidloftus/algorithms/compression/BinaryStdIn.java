 ...
 *  Compilation:  javac ie.davidloftus.algorithms.compression.BinaryStdIn.java
 *  Execution:    java ie.davidloftus.algorithms.compression.BinaryStdIn < input > output
 *  Dependencies: none             
 *  
 *  Supports reading binary data from standard input.
 *
 *  % java ie.davidloftus.algorithms.compression.BinaryStdIn < input.jpg > output.jpg
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to {@code ie.davidloftus.algorithms.compression.BinaryStdIn} with calls
 *  to {@code ie.davidloftus.algorithms.compression.StdIn} or {@code System.in};
...
public final class BinaryStdIn {
    ...
    private static boolean isInitialized;   // has ie.davidloftus.algorithms.compression.BinaryStdIn been called for first time?
   ...
   /**
    ...
    public static void close() {
        ...
        try {
            ...
            throw new IllegalStateException("Could not close ie.davidloftus.algorithms.compression.BinaryStdIn", ioe);
        }
    }
