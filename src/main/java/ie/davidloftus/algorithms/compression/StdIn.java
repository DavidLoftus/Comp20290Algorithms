 ...
 *  Compilation:  javac ie.davidloftus.algorithms.compression.StdIn.java
 *  Execution:    java ie.davidloftus.algorithms.compression.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code ie.davidloftus.algorithms.compression.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code ie.davidloftus.algorithms.compression.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">ie.davidloftus.algorithms.compression.StdIn.java</a>
 ...
 *  <pre>
 *  while (!ie.davidloftus.algorithms.compression.StdIn.isEmpty()) {
 *      double value = ie.davidloftus.algorithms.compression.StdIn.readDouble();
 *      ie.davidloftus.algorithms.compression.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (ie.davidloftus.algorithms.compression.StdIn.hasNextChar()) {
 *      char c = ie.davidloftus.algorithms.compression.StdIn.readChar();
 *      ie.davidloftus.algorithms.compression.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (ie.davidloftus.algorithms.compression.StdIn.hasNextLine()) {
 *      String line = ie.davidloftus.algorithms.compression.StdIn.readLine();
 *      ie.davidloftus.algorithms.compression.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = ie.davidloftus.algorithms.compression.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code ie.davidloftus.algorithms.compression.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code ie.davidloftus.algorithms.compression.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code ie.davidloftus.algorithms.compression.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code ie.davidloftus.algorithms.compression.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code ie.davidloftus.algorithms.compression.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code ie.davidloftus.algorithms.compression.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code ie.davidloftus.algorithms.compression.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code ie.davidloftus.algorithms.compression.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code ie.davidloftus.algorithms.compression.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to ie.davidloftus.algorithms.compression.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to ie.davidloftus.algorithms.compression.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to ie.davidloftus.algorithms.compression.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to ie.davidloftus.algorithms.compression.StdIn
    
    
    // do this once when ie.davidloftus.algorithms.compression.StdIn is initialized
    static {
        resync();
    }

    /**
     * If ie.davidloftus.algorithms.compression.StdIn changes, use this to reinitialize the scanner.
     */
